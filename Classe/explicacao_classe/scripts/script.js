...
class Veiculo{
    // CONSTRUCTOR - É UM MÉTODO ESPECIAL PARA JAVASCRIPT
...
const minhaApresentacao = new Pessoa("Julia", 17);
...
class Usuário {
    ...
    // APENAS OS ATRIBUTOS DENTRO DESTA CLASSE TEM ACESSO
...
const user = new Usuário("123456789");
user.criarConta();
...
class Carro extends Veiculo{
    constructor(marca, modelo, portas) {
        //SUPER - UTLIZADO PARA CHAMAR O CONSTRUCTOR DA CLASSE PAI
        // E REUTILIZAR SEUS TRIBUTOS
        super(marca, modelo);
        this.portas = portas;
    }

    info() {
        console.log(`A marca do carro é: ${this.marca}, seu modelo é: ${this.modelo} e ele possui ${this.portas} portas `);
    }
}
